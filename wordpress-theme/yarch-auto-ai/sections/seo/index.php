<!-- ===== SECTION: SEO ===== -->
<link rel="stylesheet" href="<?php echo esc_url(yarch_asset_url('sections/seo/css/styles.css')); ?>">
  ...
  <div class="container-site">
    ...
    <div class="seo-subsections">
      <article class="seo-subsection">
        <img class="seo-subsection__flag" src="<?php echo esc_url(yarch_asset_url('images/korea-flag.svg')); ?>" alt="Флаг Кореи">
      ...
      <article class="seo-subsection">
        <img class="seo-subsection__flag" src="<?php echo esc_url(yarch_asset_url('images/china-flag.svg')); ?>" alt="Флаг Китая">
      ...
      <article class="seo-subsection">
        <img class="seo-subsection__flag" src="<?php echo esc_url(yarch_asset_url('images/usa-flag.svg')); ?>" alt="Флаг США">
    ...
    <div class="seo-cluster card">
      ...
      <div class="seo-cluster__links">
        <a href="<?php echo esc_url(yarch_page_url('stoimost-importa-avto')); ?>" class="seo-cluster__link">Стоимость импорта авто под ключ</a>
        <a href="<?php echo esc_url(yarch_page_url('sroki-dostavki-avto')); ?>" class="seo-cluster__link">Сроки доставки авто в Россию</a>
        <a href="<?php echo esc_url(yarch_page_url('rastamozhka-avto-dokumenty')); ?>" class="seo-cluster__link">Растаможка авто и документы</a>
        <a href="<?php echo esc_url(yarch_page_url('avto-iz-korei')); ?>" class="seo-cluster__link">Импорт авто из Кореи</a>
        <a href="<?php echo esc_url(yarch_page_url('avto-iz-kitaya')); ?>" class="seo-cluster__link">Импорт авто из Китая</a>
        <a href="<?php echo esc_url(yarch_page_url('avto-iz-ssha')); ?>" class="seo-cluster__link">Импорт авто из США</a>
      </div>
    </div>
  </div>
</section>
