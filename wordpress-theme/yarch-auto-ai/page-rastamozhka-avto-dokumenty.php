...
<html lang="ru">
  <head>
    <?php
      ...
      $canonicalUrl = yarch_page_url('rastamozhka-avto-dokumenty');
    ...
    <main class="container-site topic-layout">
      <div class="topic-main">
        ...
        <article class="topic-card topic-section">
          ...
          <a class="topic-cta" href="<?php echo esc_url(home_url('/#cta')); ?>">Проверить документы до выкупа</a>
        </article>
      </div>
      ...
      <aside class="topic-aside">
        <div class="topic-card">
          ...
          <div class="topic-links">
            ...
            <a href="<?php echo esc_url(yarch_page_url('avto-iz-kitaya')); ?>">Авто из Китая</a>
